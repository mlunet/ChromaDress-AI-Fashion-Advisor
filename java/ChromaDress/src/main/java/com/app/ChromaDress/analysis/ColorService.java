...
public class ColorService {
  ...
  @Cacheable(value = "classicPalettes", key = "#hex")
  public ClassicColorDTO getClassicPalette(String hex) {
    return webClient.get()
        .uri(uriBuilder -> uriBuilder.path("/classic-palette").queryParam("hex", hex).build())
        ...
        .bodyToMono(ClassicColorDTO.class).block();
  }
}
